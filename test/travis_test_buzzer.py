...
class BuzzerTest(unittest.TestCase):
    def setUp(self):
        self.clinet = actionlib.SimpleActionClient("music", MusicAction)
        self.device_values = []

    def test_node_exit(self):
        nodes = rosnode.get_node_names()
        self.assertIn('/buzzer', nodes, "node does node exitst")
    ...
    def test_music(self):
        ...
        self.assertEqual(gal.freqs, self.device_values, "invalid feedback:"
